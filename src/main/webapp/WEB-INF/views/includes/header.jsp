    ...
    <div class="main ">
        <div class="sidebar sidebar-category">
            ...
            <ul class="nav nav-sidebar nav-main">
                ...
                <li  data-toggle="tooltip" data-placement="right" data-container="body" title="커뮤니티"><a href="/community/clist" class="link"><i class="nav-icon fa fa-comments"></i> <span class="nav-sidebar-label nav-sidebar-category-label">커뮤니티</span></a></li>
