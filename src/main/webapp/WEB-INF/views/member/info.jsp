        ...
        <div id="user" class="content clearfix" role="main">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class='avatar avatar-big clearfix col-sm-3 text-center'><a href='/user/info/94647'
                                                                                    class='avatar-photo'><img
                            src='//www.gravatar.com/avatar/9673f3346e67c0417b21e970fcc821cb?d=identicon&s=150'/></a>
                    </div>
                    <div class="user-info col-sm-9">
                        <div class="clearfix">
                            <h2 class="pull-left">${member.nickname }</h2>
                            <button class="btn btn-success pull-right btn-wide disabled"><i class="fa fa-plus"></i> 팔로우
                            </button>
                        </div>
                        <div class="user-points">
                            <div class="user-point">
                                <div class="user-point-label"><i class="fa fa-flash"></i> 활동점수</div>
                                <div class="user-point-num"><a href="/user/info/94647/activity">${member.apoint }</a>
                                </div>
                            </div>
                            <div class="user-point">
                        ...
                        <div class="list-title-wrapper list-activity">
                            ...
                            <h5 class="list-group-item-heading ">
                                ...
                                <div class="list-group-item-author pull-right clearfix">
                                    <div class='avatar avatar-x-small clearfix '><a href='/user/info/22487'
                                                                                    class='avatar-photo'><img
                                            src='//www.gravatar.com/avatar/6e61e0bff69a035c0dbd4795e504a749?d=identicon&s=10'/></a>
                                        <div class="avatar-info"><a class="nickname" href="/user/info/22487"
                                                                    title="jjsun9">jjsun9</a>
...
<!--                 <div class="text-center">
                    ...
                    <ul class="pagination pagination-sm">
                        ...
                        <li><a href="/user/info/94647/activity?offset=20&amp;max=20&amp;sort=id&amp;order=desc"
                               class="step">2</a></li>
                        <li class="next"><a
                                href="/user/info/94647/activity?offset=20&amp;max=20&amp;sort=id&amp;order=desc"
        ...
        <div class="right-banner-wrapper">
            ...
            <div class="right-banner">
                <a href="/banner/stats/292" target="_sba"><img src="//file.okky.kr/banner/1593482562407.jpg"
                                                               style="width:160px;"/></a>
            </div>
            <div class="google-ad">
