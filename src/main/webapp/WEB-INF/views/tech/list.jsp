			...
			<form action="/articles/community" method="get"
				...
				<div class="category-filter-wrapper">
					...
					<ul class="list-sort pull-left">
						<li><a href="/tech/list" data-sort="id" data-order="desc"
							class="category-sort-link active">최신순</a></li>
						<li><a href="/tech/list" data-sort="voteCount"
							data-order="desc" class="category-sort-link ">추천순</a></li>
						<li><a href="/tech/list" data-sort="noteCount"
							data-order="desc" class="category-sort-link ">댓글순</a></li>
						<li><a href="/tech/list" data-sort="scrapCount"
							data-order="desc" class="category-sort-link ">스크랩순</a></li>
						<li><a href="/tech/list" data-sort="viewCount"
						...
						<li
							...
							<div class="list-title-wrapper clearfix">
								...
								<h5 class="list-group-item-heading list-group-item-evaluate">
									<a href="/tech/get?seq=${board.seq }"> ${board.title} </a>
								</h5>
							</div>
