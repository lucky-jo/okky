...
//state: 애플리케이션이 생성한 상태 토큰
	private final static String CLIENT_ID = "QUBg_t6Mekd0j8M4IVCG";
	private final static String CLIENT_SECRET = "IoYW3KHT7T";
	...
	public String getAuthorizationUrl(HttpSession session) {
		...
		String state = generateRandomString(); // ? 검색
